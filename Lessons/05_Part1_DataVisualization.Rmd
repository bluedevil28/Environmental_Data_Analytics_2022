...
If you have one variable, can define aesthetics on the same line; if more than one, put the aesthetics arguments into the geom line (not the first ggplot one).
...
Nutrientplot6 <-
  ...
  geom_density_ridges(aes(fill = lakename), alpha = 0.5) #alpha means transparency of the points
print(Nutrientplot6)
