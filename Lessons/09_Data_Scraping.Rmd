...
df_withdrawals <- data.frame("Month" = rep(1:12),
  ...
  dplyr::mutate(Registrant = !!the_registrant,
         Facility_name = !!the_facility_name,
         Facility_type = !!the_facility_type,
         Date = my(paste(Month,"-",Year)))
...
#THIS command did not work properly!  Use the other binding function instead?
#Only brought in the year 2018
...
df_2020 <- dplyr::bind_rows(dfs_2020)
