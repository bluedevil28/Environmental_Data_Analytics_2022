...
Use when you know the variance is the same and you want to check if the means are the same.

Categorical variables are coded as factors.

Always test for normality before you use ANOVA.  If you fail the normality test, could be because the dataset is too small.
...
# Means aren't the same but puts variables with similar means in clusters
