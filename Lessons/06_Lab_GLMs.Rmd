...
pm.by.ozone <- lm(data = EPAair, PM2.5 ~ Ozone)
summary(pm.by.ozone)
...
#Add variables Month and meanLat
...
pm.by.ozone.explore <- lm(data = EPAair, PM2.5 ~ Ozone + Year + Month + 
                            meanLng + meanLat)

step(pm.by.ozone.explore)
...
pm.by.ozone.expanded <- lm(data = EPAair, PM2.5 ~ Ozone + Year)
summary(pm.by.ozone.expanded)
